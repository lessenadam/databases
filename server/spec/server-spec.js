...
describe('Persistent Node Chat Server', function() {
  ...
  it('Should output all messages from the DB', function(done) {
    ...
    var queryString = "INSERT INTO messages (u_id, msg) VALUES (2, 'Men like you can never change!');";
    var queryArgs = [];
    ...
    dbConnection.query(queryString, function(err, data) {
      // console.log('called query and my data back is---', data);
      if (err) { 
        console.log(err); 
        throw err; 
      }
      ...
      request('http://127.0.0.1:3000/classes/messages', function(error, response, body) {
        ...
        console.log('IN SPEC FILE body is: ', body); 
        // console.log('IN SPEC FILE response is: ', response); 
